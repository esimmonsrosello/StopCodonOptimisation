...
def number_of_Slippery_motifs(dna_seq):
    ...
    try:
        ...
        slippery_count = sum(1 for i in range(len(dna_seq_upper) - 3) if i % 3 == 0 and dna_seq_upper[i:i+4] in Slippery_Motifs)
...
def run_optimization(clean_seq, protein_seq, choice): # Full version
    ...
    try:
        if choice == 1:
            ...
            filename_template_for_individual_save = "Sequence_Analysis.xlsx"; analysis_type_description = "Plus1 Frame Stop Count Analysis"
